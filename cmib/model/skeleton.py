...
sk_offsets = [
       ...
       [19.7461, -1.48037, -6.00007],
       [11.2841, -1.60973e-005, 0],
       [33.0001, 1.67301e-005, 0],
       [25.1998, 0.00013865, 0.000422312],
       [0.000000, 0.000000, 0.000000],

       [19.7459, -1.48037, 6.0001],
       [11.2841, 0, -2.01028e-005],
       [33, 0, 2.94913e-005],
       [25.2, 1.66277e-005, 0],
       [0.000000, 0.000000, 0.000000],

       [0.103458, 1.85783, -10.5485],
       [43.5, -2.31574e-005, 1.06848e-005],
       [42.3723, 0, 1.26214e-005],
       [17.3, 0, 0],
       [0.000000, 0.000000, 0.000000],

       [0.103458, 1.85783, 10.5485],
       [43.5, -3.14078e-005, 0],
       [42.3722, 1.47818e-005, 0],
       [17.3, 0, 0],
       [0.000000, 0.000000, 0.000000]
    ]
"""
sk_offsets = [[0.0984907, 99.7847, -0.622151],
    [0.217141, 110.675, 0.767747],
    [-0.56615, 122.303, 1.85773],
    [-2.454, 134.837, 2.27153],
    [-4.81356, 151.538, 1.58577],
    [-6.50602, 160.203, 3.12545],
    [1.90775, 144.721, 4.28501],
    [14.7172, 146.355, 4.76789],
    [22.6839, 120.164, 3.51064],
    [26.259, 93.3066, 8.8429],
    [-9.8205, 142.944, 1.38479],
    [-19.9979, 141.064, -6.35278],
    [-30.0685, 120.133, -20.8956],
    [-28.6129, 108.48, 4.09715],
    [9.15252, 93.0886, -1.48957],
    [8.79381, 52.3559, 4.17771],
    [4.79912, 11.6775, -5.90408],
    [6.87957, 2.88789, 6.96375],
    [-9.09512, 93.2666, -1.36886],
    [-10.6873, 57.2318, 14.0717],
    [-14.0219, 19.4116, -0.663302],
    [-14.7989, 5.00823, -6.9169]]
"""
"""
...
"""
"""
sk_parents = [-1, 0,  1,  2,  3,  4,  5,
              3,  7,  8,  9,  10,
              3, 12, 13, 14, 15, 
              0, 17, 18, 19, 20, 
              0, 22, 23, 24, 25]
"""
#sk_parents = [-1,0,1,2,3,4, 0,6,7,8,9, 0,11,12,13,14,15, 13,17,18,19,20, 13,22,23,24,25,]

sk_parents = [-1,0,1,2,3,4,5, 3,7,8,9,10, 3,12,13,14,15, 0,17,18,19,20, 0,22,23,24,25,]
"""
sk_parents = [-1, 0,1,2,3,4, 3,6,7,8, 3,10,11,12, 0,14,15,16, 0,18,19,20]
"""
#sk_joints_to_remove = [5,10,16,21,26] 
sk_joints_to_remove = [6,11,16,21,26]
...
joint_names = ["Hips", "Spine", "Spine1", "Spine2", "Neck", "Head", "LeftShoulder", "LeftArm", "LeftForeArm", "LeftHand", "RightShoulder", "RightArm", "RightForeArm", "RightHand", "LeftUpLeg", "LeftLeg", "LeftFoot", "LeftToe", "RightUpLeg", "RightLeg", "RightFoot", "RightToe"]
